...
<template>
  <div class="about_us 2xl:mx-auto 2xl:container 2xl:px-20 px-6 overflow-y-hidden py-8">
    <div class="flex md:flex-row flex-col-reverse md:items-stretch items-center justify-center">
      <div
        class="md:py-20 xl:w-1/2 sm:w-1/2 lg:mr-20 md:mr-6 flex flex-col md:items-end items-center justify-center xl:mr-28"
      >
        <div class="flex flex-col items-center justify-center">
          <h1 class="md:text-5xl text-3xl font-bold text-center text-gray-800">
            Revolutionizing Real Estate
          </h1>
          <p class="md:mt-14 mt-12 text-center text-gray-950 leading-7">
            We have been working on this project for several months, researching and testing various
            models and technologies to come up with the best possible solution. We are proud to
            present our final product, which we believe can revolutionize the real estate industry.
          </p>
          <p class="sm:w-96 w-full mt-6 text-base leading-6 text-center text-gray-600"></p>
          <div class="flex flex-col items-center">
            <div
              class="w-20 h-20 bg-white shadow rounded-full flex items-center justify-center"
              role="img"
              aria-label="money"
            >
              <svg
            ...
            <p class="text-base leading-6 mt-6 text-center text-gray-600 sm:w-96 w-full">
              Accurate house value predictions based on various factors
            </p>
          </div>
          <div class="mt-7 flex flex-col items-center">
            ...
            <p class="text-base leading-6 mt-6 text-center text-gray-600 sm:w-96 w-full">
              Fast and secure distributed architecture
            </p>
          </div>
          <div class="mt-7 flex flex-col items-center">
            <div
            ...
            <p class="text-base leading-6 mt-6 text-center text-gray-600 sm:w-96 w-full">
              Modern technologies used for development
            </p>
          </div>
          <div class="mt-7 flex flex-col items-center">
            <div
            ...
            <p class="text-base leading-6 mt-6 text-center text-gray-600 sm:w-96 w-full">
              Open-source code that can be easily modified and extended
            </p>
          </div>
        </div>
      </div>
      <div class="py-12 xl:w-1/2 lg:w-1/3 sm:w-1/2">
        <img
          src="https://images.pexels.com/photos/4906249/pexels-photo-4906249.jpeg"
